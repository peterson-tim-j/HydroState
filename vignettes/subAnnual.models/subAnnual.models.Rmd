...
```r
model.monthly.default = fitModel(model.monthly.default, pop.size.perParameter = 10, max.generations = 10000)
...
plot.residuals(model.monthly.default, do.pdf = F, ID ='221201')
...
model.monthly.default = setInitialYear(model.monthly.default, 1990)
model.monthly.adjusted = setInitialYear(model.monthly.adjusted, 1990)


# plot all four plots
plot.states(model.monthly.default)

plot.states(model.monthly.adjusted)
...
```r
# Build all possible models with the intercept as a seasonal parameter
...
<!-- all.models.monthly = fitModel(all.models.monthly) -->

best.Model = get.AIC(all.models.monthly.fitted.221201)
```
