...
Review the model's residuals from figures using `plot_residuals` to ensure they are uniform and normally distributed with no trends or auto-correlation.

```r
# review residual plots
plot_residuals(model.monthly.adjusted, do.pdf = F, ID ='221201')
```
...
# plot all four plots
plot_states(model.monthly.adjusted, dopdf = T)
...
<!-- all.models.monthly = fitModel(all.models.monthly, pop.size.perParameter = 10, max.generations = 500, doParallel = T) -->
