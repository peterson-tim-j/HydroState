...
![The residual plots of the best seasonal model for site 415201 appear uniform and normally distributed despite the Shapiro-Wilk p-value being less than 0.05.](../man/figures/subAnnual.model.residuals.png){width=100%}
...
get.AIC(all.models.seasonal)

#>                                                  AIC    nParameters   AIC.weights
#> model.3State.gamma.boxcox.AR2.a0.seasonal.a0std 101.7086          23 9.999966e-01
#> model.3State.gamma.boxcox.AR3.a0.seasonal.a0std 126.8749          24 3.429339e-06
#> model.2State.gamma.boxcox.AR3.a0.seasonal.a0std 137.4552          15 1.728674e-08
#> model.2State.gamma.boxcox.AR1.a0.seasonal.a0std 156.0379          13 1.594226e-12
#> ...
```
