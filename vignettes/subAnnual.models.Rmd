...
plot(model.seasonal.fitted.415201, pse.residuals = TRUE, siteID = '415201') 

```

![The residual plots of the best seasonal model for site 415201 are uniform and normally distributed with the Shapiro-Wilk p-value being greater than 0.05.](../man/figures/subAnnual.model.residuals.png){width=100%}
...
# plot all four plots
plot(model.seasonal.fitted.415201)
