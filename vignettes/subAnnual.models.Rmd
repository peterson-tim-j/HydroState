...
plot.residuals(model.monthly.fitted.415201, pse.residuals = TRUE, siteID = '415201', do.pdf = FALSE) 

```

![The residual plots of the best monthly model for site 415201 appear uniform and normally distributed despite the Shapiro-Wilk p-value being less than 0.05.](subAnnual.model.residuals.png){width=80%}
