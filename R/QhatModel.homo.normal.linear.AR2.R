...
setMethod("initialize","QhatModel.homo.normal.linear.AR2", function(.Object, input.data, transition.graph=matrix(T,2,2),
  ...
  .Object@parameters$mean.AR1 = 0.1;
  .Object@parameters$mean.AR2 = 0.1;
  ...
  if (state.dependent.mean.AR1)
    .Object@parameters$mean.AR1 = rep(.Object@parameters$mean.AR1, .Object@nStates);
  if (state.dependent.mean.AR2)
    .Object@parameters$mean.AR2 = rep(.Object@parameters$mean.AR2, .Object@nStates);
...
setMethod(f="setParameters",
          signature="QhatModel.homo.normal.linear.AR2",
          definition=function(.Object,parameters)
          {
            ...
            .Object@parameters$mean.AR1 <- parameters$mean.AR1;
            .Object@parameters$mean.AR2 <- parameters$mean.AR2;
            validObject(.Object)
            return(.Object)
          }
)
...
setMethod(f="getParameters",
          ...
          {
            return(list(mean.a1=.Object@parameters$mean.a1,mean.a0=.Object@parameters$mean.a0,
                        mean.AR1=.Object@parameters$mean.AR1, mean.AR2=.Object@parameters$mean.AR2,
                        std.a0=.Object@parameters$std.a0))
          }
)
...
setMethod(f="getTransformedParameterBounds",
          ...
          definition=function(.Object)
          {
            ...
            lowerBound = list(mean.a1 = rep(-6, length(.Object@parameters$mean.a1)),
                              ...
                              mean.AR1 = rep(-1, length(.Object@parameters$mean.AR1)),
                              mean.AR2 = rep(-1, length(.Object@parameters$mean.AR2)),
...
setMethod(f="getMean",signature=c("QhatModel.homo.normal.linear.AR2","data.frame"),definition=function(.Object, data)
          {
            ...
            ncols.AR1 = length(.Object@parameters$mean.AR1)
            ncols.AR2 = length(.Object@parameters$mean.AR2)
            nrows = length(data$precipitation);
            ncols.max = max(c(ncols.a0 ,ncols.a1,ncols.AR1,ncols.AR2))
            ...
            if (ncols.AR1==1 || ncols.AR1 ==.Object@nStates) {
              AR1.est = matrix(rep(.Object@parameters$mean.AR1,each=nrows),nrows,.Object@nStates);
            } else if (mean.AR1<.Object@nStates) {
              stop(paste('The number of parameters for the a0 term of the mean model must must equal 1 or the number of states of ',.Object@nStates))
            }
            if (ncols.AR2==1 || ncols.AR2 ==.Object@nStates) {
              AR2.est = matrix(rep(.Object@parameters$mean.AR2,each=nrows),nrows,.Object@nStates);
